...
import { Status, Span, Attributes } from '@opentelemetry/api';
import { RequestOptions, IncomingMessage, ClientRequest, IncomingHttpHeaders, OutgoingHttpHeaders, ServerResponse } from 'http';
import { IgnoreMatcher, Err, ParsedRequestOptions, SpecialHttpStatusCodeMapping } from './types';
 ...
 * Get an absolute url
 */
export declare const getAbsoluteUrl: (requestUrl: RequestOptions | (RequestOptions & Partial<url.UrlWithParsedQuery>) | null, headers: IncomingHttpHeaders | OutgoingHttpHeaders, fallbackProtocol?: string) => string;
/**
 ...
 */
export declare const hasExpectHeader: (options: RequestOptions | url.URL) => boolean;
/**
 ...
 */
export declare const getRequestInfo: (options: string | RequestOptions | url.URL, extraOptions?: RequestOptions | undefined) => {
    origin: string;
    pathname: string;
    method: string;
