...
exports.HTTP_STATUS_SPECIAL_CASES = {
    401: api_1.CanonicalCode.UNAUTHENTICATED,
    403: api_1.CanonicalCode.PERMISSION_DENIED,
    404: api_1.CanonicalCode.NOT_FOUND,
    429: api_1.CanonicalCode.RESOURCE_EXHAUSTED,
    501: api_1.CanonicalCode.UNIMPLEMENTED,
    503: api_1.CanonicalCode.UNAVAILABLE,
    504: api_1.CanonicalCode.DEADLINE_EXCEEDED,
    598: api_1.CanonicalCode.INTERNAL,
    599: api_1.CanonicalCode.INTERNAL,
};
/**
 * Get an absolute url
 */
...
exports.parseResponseStatus = (statusCode) => {
    ...
    const code = exports.HTTP_STATUS_SPECIAL_CASES[statusCode];
    if (code !== undefined) {
        return { code };
    }
    // 0xx are unknown
    ...
    // 1xx, 2xx, 3xx are OK
    if (statusCode < 400) {
        return { code: api_1.CanonicalCode.OK };
    }
...
exports.setSpanWithError = (span, error, obj) => {
    ...
    if (!obj) {
        span.setStatus({ code: api_1.CanonicalCode.UNKNOWN, message });
        return;
    }
    let status;
    if (obj.statusCode) {
        ...
        status = { code: api_1.CanonicalCode.UNKNOWN };
    }
 ...
 */
exports.getIncomingRequestAttributesOnResponse = (request, response) => {
    ...
    if (route !== undefined) {
        attributes[AttributeNames_1.AttributeNames.HTTP_ROUTE] = route;
    }
    return attributes;
};
