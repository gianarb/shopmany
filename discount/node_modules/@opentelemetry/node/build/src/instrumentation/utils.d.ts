 ...
 */
export declare function getPackageVersion(logger: Logger, basedir: string): string | null;
/**
 ...
 */
export declare function isSupportedVersion(moduleVersion: string, supportedVersions?: string[]): boolean;
/**
